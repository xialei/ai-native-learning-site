...
> 提示：可对照源码仓库一起看。每个页面中标注的 `lerobot/src/lerobot/...`、`isaaclab/source/...` 等相对路径都对应 `/Users/lei.xia/workspace/github/robotics/` 下的真实文件。
...
| `01-overview.html` | 全景 | 模仿学习 vs RL vs VLA 三范式对比、全书知识地图、四仓库分工 |
